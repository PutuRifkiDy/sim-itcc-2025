    ...
    return (
        <svg width="24" height="24" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                stroke="url(#paint0_linear_41_32083)"
                strokeWidth="4"
                strokeLinecap="round"
                strokeLinejoin="round"
            />
...
export const IconDropdown = ({ ...props }) => {
    return (
        ...
        >
            ...
            />
            <mask id="mask0_41_20480" maskUnits="userSpaceOnUse" x="7" y="8" width="6" height="4">
                <path
                    d="M10 10.7929L7.73162 8.14645C7.56425 7.95118 7.29289 7.95118 7.12553 8.14645C6.95816 8.34171 6.95816 8.65829 7.12553 8.85355L9.69695 11.8536C9.86432 12.0488 10.1357 12.0488 10.303 11.8536L12.8745 8.85355C13.0418 8.65829 13.0418 8.34171 12.8745 8.14645C12.7071 7.95118 12.4358 7.95118 12.2684 8.14645L10 10.7929Z"
                    fill="white"
                />
    ...
    return (
        <svg width="140" height="140" viewBox="0 0 140 140" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M72.5 81C79.4036 81 85 86.5964 85 93.5C85 100.301 79.5694 105.833 72.8082 105.996L72.5 106H71.5C67.9101 106 65 108.91 65 112.5C65 116.012 67.785 118.873 71.2669 118.996L71.5 119H109V125H71.5C64.5964 125 59 119.404 59 112.5C59 105.699 64.4306 100.167 71.1918 100.004L71.5 100H72.5C76.0899 100 79 97.0899 79 93.5C79 89.9882 76.215 87.1268 72.7331 87.0041L72.5 87H37V81H72.5Z"
                fill="#131523"
            />
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M37 87C51.3594 87 63 70.8823 63 51C63 31.1177 51.3594 15 37 15C22.6406 15 11 31.1177 11 51C11 70.8823 22.6406 87 37 87ZM37 53C43.6274 53 49 47.6274 49 41C49 34.3726 43.6274 29 37 29C30.3726 29 25 34.3726 25 41C25 47.6274 30.3726 53 37 53Z"
                fill="#59DFD1"
            />
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M109 125C120.598 125 130 112.016 130 96C130 79.9837 120.598 67 109 67C97.402 67 88 79.9837 88 96C88 112.016 97.402 125 109 125ZM109 98C114.523 98 119 93.5228 119 88C119 82.4772 114.523 78 109 78C103.477 78 99 82.4772 99 88C99 93.5228 103.477 98 109 98Z"
                fill="#A1A7C4"
            />
        </svg>
    );
...
export const IconProposal = () => {
    return (
        <svg width="22" height="22" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M22 10V15C22 20 20 22 15 22H9C4 22 2 20 2 15V9C2 4 4 2 9 2H14M22 10H18C15 10 14 9 14 6V2M22 10L14 2"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
...
export const IconPencil = () => {
    return (
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M5.3452 16.923L0.000701904 18L1.0792 12.6562L5.3452 16.923ZM2.1397 11.595L6.4057 15.8617L18.0007 4.26675L13.734 0L2.1397 11.595Z"
                fill="currentColor"
            />
        </svg>
    );
    ...
    return (
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M14.0003 2.3335L21.8196 5.26573C22.7303 5.60724 23.3337 6.47786 23.3337 7.4505V16.3335C23.3337 21.4882 14.0003 25.6668 14.0003 25.6668C14.0003 25.6668 4.66699 21.4882 4.66699 16.3335V7.4505C4.66699 6.47786 5.27033 5.60724 6.18104 5.26573L14.0003 2.3335ZM14.0003 4.82433L7.00033 7.4505V16.3335C7.00033 20.1995 14.0003 23.3335 14.0003 23.3335C14.0003 23.3335 20.8575 20.3403 20.9955 16.5959L21.0003 16.3335V7.4505L14.0003 4.82433ZM18.2563 9.3335L19.8337 10.9553L12.3017 18.6668L8.16699 14.4156L9.74431 12.7937L12.3017 15.4223L18.2563 9.3335Z"
                fill="#4DE45C"
            />
        </svg>
    );
