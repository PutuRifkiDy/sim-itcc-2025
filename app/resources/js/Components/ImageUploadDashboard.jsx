                ...
                <InputLabel className="" >
                    <div className={cn("flex flex-col gap-5 justify-center items-center border-[#495190] border-2 border-dashed p-16 cursor-pointer rounded-xl", classNameForBG)}>
                        ...
                        <div className="flex flex-col gap-1 justify-center items-center">
                            <p className="font-bold text-[14px] text-[#5E5E5E] dark:text-white text-center">Choose a file or drag & drop it here</p>
                            <p className="text-[14px] font-medium text-[#ACACAC]">JPG, PNG, max 1MB </p>
                        </div>
                    </div>
                </InputLabel>
                {imagePath?.name && (
