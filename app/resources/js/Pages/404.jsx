...
export default function Error404() {
    return (
            <div className="flex flex-col items-center justify-center py-20">
                <Icon404/>
                <h1 className="font-bold text-[35px] text-[#0F114C]">Page Not Found</h1>
                <p className="text-[#3A3A3A] text-xl">The page you are trying to access doesn’t exist or has been removed.</p>
