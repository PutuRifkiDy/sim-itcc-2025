export default function About() {
    return (
      <section className="w-full min-h-[500px] relative bg-gradient-to-r from-indigo-950 to-sky-800 overflow-hidden md:mt-80 mt-24">
        ...
        <div className="md:flex-row flex-col flex items-center md:justify-evenly justify-center container mx-auto px-4 md:pt-32 pt-10 gap-8 pb-24">
          <img className="md:w-96 w-60" src="assets/images/about/ITCCLogo.png" alt="ITCC 2025 Logo" />
          <div className="md:w-[600px] relative">
            ...
            <img className="absolute top-0 right-0 md:w-10 w-6" src="assets/images/about/bluePlus.png" alt="" />
