...
export default function Merch() {
  ...
  return (
    <section className="flex flex-col items-center md:pl-12 py-10 mt-24">
      ...
      <div className="flex md:flex-row flex-col-reverse justify-between md:mt-24 mt-4 px-12">
        <div className="relative flex flex-col justify-center gap-8 w-full">
          <h1 className="font-bold text-[33px] leading-[1.2em] tracking-[0.16em] text-[#000000] uppercase md:text-start text-center" data-aos="fade-left">
            ITCC 2025 Merchandise
          </h1>
          <p className="font-reguler text-[17px] tracking-[0.04em] leading-[1.5em] text-[#121212] md:w-[427px] max-w-[700px] md:text-start text-center" data-aos="fade-left" data-aos-delay="100">
          ...
          <div className="flex md:flex-row flex-col md:gap-7 gap-5 justify-center md:justify-start" data-aos="fade-left" data-aos-delay="100">
            <button className="bg-[#0F114C] text-white px-6 py-2 rounded-[10px] font-semibold">
              Buy Now{" "}
              <img src="assets/images/landingArrow.svg" className="inline ml-4" alt="" />
            </button>
