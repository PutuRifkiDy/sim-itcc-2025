...
export default function Error403() {
    return (
            <div className="flex flex-col items-center justify-center py-20">
                <Icon403/>
                <h1 className="font-bold text-[35px] text-[#0F114C] dark:text-white">Access Denied</h1>
                <p className="text-[#3A3A3A] text-xl dark:text-white">The Page you are trying to access has restricted access.</p>
