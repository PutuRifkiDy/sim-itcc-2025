...
export default function Error500() {
    return (
            <div className="flex flex-col items-center justify-center py-20">
                <Icon500/>
                <h1 className="font-bold text-[35px] text-[#0F114C] dark:text-white">Server Error</h1>
                <p className="text-[#3A3A3A] text-xl dark:text-white">Sorry, Something went wrong.</p>
