...
import { BackButton, BigCircleBg } from "../Icons/MerchIcons"
            ...
            <div className="flex flex-col md:flex-row gap-8 max-w-5xl mx-auto">
                <div className="flex-1">
                    <div className="bg-white rounded-lg pb-6 shadow-lg border-2 border-[#808080]">
                        <img
                            src="/image/merch/itcc-tshirt.png"
                            alt="ITCC T-Shirt"
                    ...
                    <div className="flex justify-center gap-10 mt-4">
                        <div className="border-2 border-[#808080] bg-white rounded-lg p-4 cursor-pointer">
                            <img
                                src="/image/merch/black-tshirt.png"
                                alt="Black T-Shirt"
                        ...
                        <div className="border-2 border-[#808080] bg-white rounded-lg p-4 cursor-pointer">
                            <img
                                src="/image/merch/white-tshirt.png"
                                alt="White T-Shirt"
                                className="w-24 h-24 object-contain"
                            />
                ...
                <div className="flex-1">
                    <div className="bg-white rounded-lg p-6 shadow-lg h-full border-2 border-[#808080]">
                        <h1 className="text-2xl font-bold text-[#0F114C] mb-4">ITCC 2025 T-Shirt</h1>
                        <p className="text-gray-600 mb-10 md:mb-44">
                            These are our newest ITCC merch design that comes up with black and white t-shirt! Pick yours now by clicking the button below!
                        </p>
                        <p className="text-2xl md:text-5xl font-semibold mb-6">Rp. 100.000</p>
                        ...
                        <div className="space-y-4">
                            <div className="items-center gap-4 rounded-lg p-8 border-2 border-[#808080]">                         
                                <div className="flex mb-4 gap-10 items-center">
                                    <img src="/image/merch/preorder-icon.png" alt="" className="w-10 h-10 m-4" />
                                    <div>
                                        <h3 className="font-medium">Pre-Order Batch I</h3>
                                        <p className="text-sm text-gray-600">30 Agustus 2024 - 24 Oktober 2024</p>
                                    </div>
                                </div>
                                <hr className="w-full h-[20px] bg-[#808080]"></hr>
                                <div className="flex mt-4 gap-10 items-center">
                                    <img src="/image/merch/pick-up-icon.png" alt="" className="w-10 h-10" />
                                    <div>
