const Competition = () => {
  return (
    <div className="w-full max-w-[1440px] min-h-[2127px] flex-shrink-0 bg-white mx-auto px-4">
      <h1 className="text-center text-[#0F114C] font-rubik font-bold uppercase leading-[120%] tracking-[0.36em] text-3xl md:text-4xl">
        OUR COMPETITIONS
      </h1>
      <p className="text-[#5E5E5E] text-center font-rubik text-base font-normal leading-[180%] tracking-[0.02em] max-w-[653px] mt-6 mx-auto">
      ...
      <div className="w-full flex justify-end pr-10 mt-8 py-4">
        <div className="w-[50px] h-[50px] rotate-[31.594deg] flex-shrink-0">
          <svg
            ...
            fill="none"
          >
            <g clipPath="url(#clip0_613_46281)">
              <path
